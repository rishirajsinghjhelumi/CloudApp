var newBlogDetails = function(journeyId){
	...
	this.getGeneratedBlog = function(blogId){
		...
		content += 'Generated By The Traveler Book';
	...
	this.init = function(){
		...
		if(this.error == null){
			...
			dialog.realize();
			dialog.open();
			dialog.getButton('post-button').click();
...
var postBlog = function(journeyId){
	var tempBlog = new newBlogDetails(journeyId);
	tempBlog.init();
}

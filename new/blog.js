...
var newBlogDetails = function(journeyId){
	...
	this.init = function(){
		...
		if(this.error == null){
			...
			this.getUserDetail();
			this.getUserBlogDetails();http://localhost:8080/blog/profile
			this.loadJourney();
			this.postJourney();
		}else{
			console.log(this.error);
...
$(document).ready(function() {
	newUser = new newBlogDetails("ahxkZXZ-Z2NkYzIwMTMtdGhldHJhdmVsZXJib29rchQLEgdKb3VybmV5GICAgICAgIALDA");
	newUser.init();
});